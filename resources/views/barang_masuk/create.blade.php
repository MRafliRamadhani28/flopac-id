<x-app-layout title="Tambah Barang Masuk - Flopac.id" icon='<i data-lucide="notebook-pen" class="me-3"></i> Tambah Barang Masuk'>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control minimal-input" id="no_barang_masuk" 
                                   value="{{ $noBarangMasuk }}" readonly style="background-color: #f8f9fa;">
                            <label for="no_barang_masuk">No Barang Masuk (Auto Generate)</label>
                        </div>
                                ...
                                <table class="table table-hover align-middle table-transparent" id="barangTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="font-weight: 600; color: var(--color-foreground);">Qty Masuk</th>
...
<div class="modal fade" id="addBarangModal" tabindex="-1" aria-labelledby="addBarangModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="search-container mb-3">
                    <div class="search-input">
                        ...
                        <input type="text" id="searchBarang" class="form-control minimal-input" placeholder="Cari barang..." style="padding-left: 2.5rem;">
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Form submission handler dengan custom validation
            setupAjaxForm('#barangMasukForm', {
                loadingTitle: 'Menyimpan Barang Masuk...',
                loadingText: 'Sedang memproses data barang masuk',
                successTitle: 'Barang Masuk Berhasil Disimpan!',
                successText: 'Data barang masuk telah berhasil disimpan',
        ...
        function updateTableDisplay() {
            ...
            if (selectedBarang.length === 0) {
                ...
                selectedBarang.forEach((item, index) => {
                    html += `
                        <tr>
                            ...
                            <td>
                                ${editMode ?
                                    `<input type="number" class="form-control minimal-input" style="width: 80px; padding: 0.375rem 0.75rem;" value="${item.stock_masuk}" onchange="updateStock(${index}, this.value)" min="1">` :
                                    item.stock_masuk
                                }
                            </td>
                ...
                if (actionColumn) actionColumn.style.display = editMode ? 'table-cell' : 'none';
